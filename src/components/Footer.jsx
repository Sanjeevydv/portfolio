  ...
  return (
    <footer className="bg-gray-200 dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-500 py-8">
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-center lg:justify-start gap-3">
              <FaGithub size={20} />
              <a href="https://github.com/Sanjeevydv" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">
                GitHub
              </a>
            </div>
            <div className="flex items-center justify-center lg:justify-start gap-3">
              <FaLinkedin size={20} />
              <a href="https://www.linkedin.com/in/sanjeevydv09/" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">
                LinkedIn
              </a>
            </div>
            <div className="flex items-center justify-center lg:justify-start gap-3">
              <FaTwitter size={20} />
              <a href="https://twitter.com/Sanj_ev" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">
                Twitter
              </a>
            </div>
          </div>
      ...
      <p className="mt-8 text-center text-gray-500 dark:text-gray-400 text-sm">
        &copy; {new Date().getFullYear()} Sanjeev Kumar. All rights reserved.
      </p>
    </footer>
  );
}
