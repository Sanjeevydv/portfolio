  ...
  return (
    <section id="home" className="min-h-screen flex flex-col md:flex-row bg-gray-100 dark:bg-gray-900 transition-colors duration-500">
      ...
      <div className="lg:w-5/12 w-full flex flex-col justify-center items-start px-6 lg:px-16 py-12 space-y-4">
        ...
        >
          <a href="mailto:sanjeevkumar4p@gmail.com" className="p-3 bg-white dark:bg-gray-800 shadow-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-transform transform hover:scale-110 rounded-lg">
            <Mail size={24} className="text-gray-800 dark:text-white" />
          </a>
          <a href="https://github.com/Sanjeevydv" target="_blank" rel="noopener noreferrer" className="p-3 bg-white dark:bg-gray-800 shadow-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-transform transform hover:scale-110 rounded-lg">
            <Github size={24} className="text-gray-800 dark:text-white" />
          </a>
          <a href="https://linkedin.com/in/sanjeevydv09" target="_blank" rel="noopener noreferrer" className="p-3 bg-white dark:bg-gray-800 shadow-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-transform transform hover:scale-110 rounded-lg">
